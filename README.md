...
4. **Maps tags to definitions** — each tag looked up in a shared field dictionary with human-readable names
5. **Decodes compound fields** — `:32A:` encodes date + currency + amount in one value, decoded into separate fields
